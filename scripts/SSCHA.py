...
Submitter.base_script_QE = utils.base_script_QE
utils.create_scripts(folder,CALCULATOR)

TRAINED_FLAG = False
GAMMA        = 200
MLIP_PATH    = '/projects/academic/ezurek/francesco/mlip-2-master/bin/mlp'
MTP_handler  = MTP_Environment(POPULATION,ENS_FOLDER,GAMMA,ADDRESS,folder,MLIP_PATH)
